...
function App() {
	return (
		<div>
			<div className="container container-small"><p>Some text<br></br>Did you know that this and that is intersting?</p></div>
			<div className="container">
				...
				<div className='cardsGroup'>
					...
					<Card title="Number Theory" image={imgLab} buttonText= "texto do b"></Card>
				</div>
			</div>
			<div className="container">
